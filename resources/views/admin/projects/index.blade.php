            ...
            <div class="col-md-9 col py-2">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item fw-semibold" aria-current="page">Projects</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card m-0">
            <div class="card-body px-md-4 px-3 py-md-3 py-3">
                <div class="col d-flex align-items-center justify-content-between mb-3 gap-md-0 gap-2">
                    <h4 class="m-0">List Projects</h4>
                    <a class="btn btn-primary d-flex align-items-center fs-2" href="{{ route('admin.create_projects') }}" role="button">
                        <i class="ti ti-square-rounded-plus fs-5"></i>
                        <span class="d-md-block d-none ms-2">Add New</span>
                    </a>
                </div>
                <table class="table table-bordered hover" id="listprojects" style="width: 100%">
                    <thead>
                        <tr>
                            <th scope="col">No</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            ...
            <div class="modal-body text-center mt-3 mb-1">
                <p id="desc-info">Are you sure, you want to Delete this Project?</p>
            </div>
...
<script>
    ...
    $(function() {
        $('#listprojects').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin.data_projects') }}',
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        class: 'text-center'
    ...
    function formDelete(id){
        $('#form_delete').attr('action', '{{ url('/admin/projects/delete/') }}' + '/' + id);
    };
</script>
@endsection