    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body d-flex align-items-center justify-content-between px-md-4 px-3 pb-0">
                <h5 class="fw-semibold">Update Videos</h5>
            ...
            <form class="form-horizontal r-separator" action="{{ route('admin.update_videos', ['id' => $videos->id]) }}" method="POST">
                @csrf
                <div class="card-body px-md-4 px-3 py-3">
                    <div class="form-group row flex-md-row flex-column align-items-center mb-0 border-top">
                        ...
                        <div class="col-md-9 input-field border-start pb-2 pt-md-2">
                            <input type="text" class="form-control" name="title" value="{{ $videos->title }}" placeholder="Title">
                            @error('title')
                    ...
                    <div class="form-group row flex-md-row flex-column align-items-center mb-0">
                        ...
                        <div class="col-md-9 input-field border-start pb-2 pt-md-2">
                            <input type="url" class="form-control" name="video_link" value="{{ $videos->video_link }}" placeholder="Video Link">
